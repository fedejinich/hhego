...
func BenchmarkHhe1(b *testing.B) {
	...
	hheBench(b, pastaSecretKey, plaintext, uint64(plainMod), uint64(modDegree), uint64(secLevel), uint64(matrixSize),
		uint64(bsgN1), uint64(bsgN2), useBsGs)
}

func BenchmarkHhe2(b *testing.B) {
	pastaSecretKey := []uint64{
		0x07a30, 0x0cfe2, 0x03bbb, 0x06ab7, 0x0de0b, 0x0c36c, 0x01c39, 0x019e0,
		0x0e09c, 0x04441, 0x0c560, 0x00fd4, 0x0c611, 0x0a3fd, 0x0d408, 0x01b17,
		0x0fa02, 0x054ea, 0x0afeb, 0x0193b, 0x0b6fa, 0x09e80, 0x0e253, 0x03f49,
...
func BenchmarkHhe3(b *testing.B) {
	pastaSecretKey := []uint64{
...
func BenchmarkHhe4(b *testing.B) {
	pastaSecretKey := []uint64{
...
func hheBench(b *testing.B, pastaSecretKey, plaintext []uint64, plainMod, modDegree, secLevel, matrixSize,
...
func benchBfvString(name string, modDegree, plainMod, matrixSize uint64) string {
	return fmt.Sprintf("Bench %s, bfv.modDegree = %d, bfv.plainMod = %d, matrixSize = %d\n",
		name, modDegree, plainMod, matrixSize)
}
