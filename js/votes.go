...
func main() {
	...
	vote1, vote1Pasta := generateVote([]uint64{0, 1, 0, 0}, encryptor, pastaCipher, bfvParams)
	fmt.Printf("vote1 %d + vote1Pasta %d\n", vote1, vote1Pasta)
	vote2, vote2Pasta := generateVote([]uint64{0, 1, 0, 0}, encryptor, pastaCipher, bfvParams)
	fmt.Printf("vote2 %d + vote2Pasta %d\n", vote2, vote2Pasta)
	vote3, vote3Pasta := generateVote([]uint64{0, 0, 1, 0}, encryptor, pastaCipher, bfvParams)
	fmt.Printf("vote3 %d + vote3Pasta %d\n", vote3, vote3Pasta)
	vote4, vote4Pasta := generateVote([]uint64{0, 1, 0, 0}, encryptor, pastaCipher, bfvParams)
	fmt.Printf("vote4 %d + vote4Pasta %d\n", vote4, vote4Pasta)
	vote5, vote5Pasta := generateVote([]uint64{0, 0, 0, 1}, encryptor, pastaCipher, bfvParams)
...
func generateVote(vote []uint64, bfvCipher rlwe.Encryptor, pastaCipher pasta.Pasta,
	params bfv.Parameters) ([]uint64, []uint64) {
